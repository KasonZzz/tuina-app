	...
	<view class="container">
		<view class="section">
			<view class="d-flex justify-content-between align-items-center pt-40 pb-40">
				...
				<button type="primary" plain class="member-btn" @tap="member">登录按摩院星球</button>
			</view>
...
<script>
	...
	export default {
		...
		data() {
			return {
				benefits: [
					{title: '按摩院满减券', image: '/static/images/my/member_benefits/me_rights_icon_1jia1.png'},
					{title: '按摩院买赠券', image: '/static/images/my/member_benefits/me_rights_icon_qingshi.png'}
				],
				disBenefits: [
					...
					{title: '按摩院轻食劵', image: '/static/images/my/member_benefits/me_rights_icon_qingshi_dis.png'},
