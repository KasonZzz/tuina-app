<template>
	<view class="container">
		<view class="brand"  >
			<image @click="chegaeUserPic" src="https://img2.woyaogexing.com/2021/01/28/1cb62cf83f2642b8bd427c3f58d3bc5b!400x400.webp" class="avatar"></image>
			<view class="username">{{form.username}}</view>
		</view>
		...
		<modal :show="telphoneModalVisible" custom padding="40rpx 30rpx">
			<view class="telphone-modal">
				...
				<view class="tips">
					为保障您正常使用上门推拿，请在绑定前确定新手机号未绑定上门推拿
				</view>
