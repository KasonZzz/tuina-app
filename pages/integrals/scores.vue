		...
		<view class="flex-fill overflow-hidden">
			...
			<scroll-view class="content" scroll-y v-else>
				...
				<list-cell v-for="(score, index) in scores" :key="index">
					<view class="score">
						<view class="left">
							<view class="title mb-10">精油开背</view>
							<view class="mb-10">哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈</view>
							<view>{{score.createAt}}</view>
						</view>
					</view>
				</list-cell>
				<nomore :visible="!loading" :line="false" text="没有更多评论记录了~"></nomore>
			</scroll-view>
		</view>
	</view>
</template>
