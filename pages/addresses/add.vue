		...
		<view class="address-form">
			<list-cell padding="30rpx">
				<view class="form-item">
					...
					<input type="text" v-model="form.name" placeholder="请填写您的名称" placeholder-class="placeholder" />
				</view>
			</list-cell>
			<list-cell padding="30rpx">
				<view class="form-item">
			...
			<list-cell padding="30rpx">
				<view class="form-item">
					...
					<input type="text" v-model="form.phone" placeholder="请填写联系号码" placeholder-class="placeholder" />
				</view>
			</list-cell>
			<list-cell padding="30rpx">
				<view class="form-item">
