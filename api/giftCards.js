        ...
        "product_list": [
            {
                ...
                "apply_shop": "仅限中国大陆地区（不含港澳台）指定按摩院门店使用",
                "available_period": "全天",
                "use_need_knows": [
                    "1、本卡为阿喜有礼电子卡；",
                    "2、阿喜有礼电子卡的激活有效期为购买之日起1年内，成功激活后有3年的使用有效期；",
                    "3、成功激活后，您可以在按摩院或中国大陆按摩院门店（不含港澳台）使用阿喜有礼电子卡购买指定出售的商品；",
                    "4、阿喜有礼卡电子卡可自用可赠送好友；",
                    ...
                    "10、建议购买阿喜有礼电子卡后使用按摩院点单自取或门店POS扫按摩院会员码付款；阿喜有礼电子卡不支持第三方外卖使用；",
                    "11、更多使用说明与须知详情请见《使用须知》及《按摩院单用途商业预付卡章程》。"
                ],
