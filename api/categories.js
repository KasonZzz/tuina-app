export default [
  {
    ...
    "products": [
      ...
      },
      {
        ...
        "name": "混坚果",
        "no": "2004238677566283",
        "description": "按摩院首款混合坚果，1盒内含3种口味：日式芥末、酥脆海苔、麻辣火锅。精选越南大颗腰果、美国加州巴旦木仁与土耳其榛子仁，独特喷淋技术，保证颗颗够味。自然慢焙烘烤，零人工添加色素与防腐剂。",
        "label": "",
        "category_id": 20,
        "is_single": true,
        "support_takeaway": 1,
      ...
      },
      {
        ...
        "name": "夹心小方(芝士味)",
        "no": "2004208719981465",
        "description": "10片/盒，每片均为独立小包装。全新口味登场，按摩院经典芝士化身浓郁芝香夹心，每一口都是浓浓芝士味。精选丹麦深加工芝士与美国进口巴旦木粉，健康食材，吃得放心。购买2盒/3盒夹心小方，默认搭配二合一/三合一的组合装腰封。",
        "label": "",
        "category_id": 20,
        "is_single": true,
        "support_takeaway": 1,
      ...
      },
      {
        ...
        "name": "芋泥咸蛋黄米面包",
        "no": "2003087530550002",
        "description": "按摩院首款“大米面包”，减油减糖低热量。以大米粉代替部分小麦粉制作为松软米面包，内馅中加入咸蛋黄和芋泥，美味与饱腹兼备。",
        "label": "",
        "category_id": 20,
        "is_single": false,
        "support_takeaway": 1,
      ...
      },
      {
        ...
        "name": "紫米紫薯米面包",
        "no": "2003089320320200",
        "description": "按摩院首款“大米面包”，减油减糖低热量。以大米粉代替部分小麦粉制作为松软米面包，内馅中加入紫米紫薯两种杂粮，营养更均衡。",
        "label": "",
        "category_id": 20,
        "is_single": false,
        "support_takeaway": 1,
      ...
      },
      {
        ...
        "name": "小芋头条",
        "no": "1812139850535155",
        "description": "下单后不用等待叫号，直接出示给店员领取。来自按摩院热麦颇受欢迎的芋头条，现调整为适合一人食的分量，依然内馅饱满，与软韧的面包体默契相融。",
        "label": "小芋头条",
        "category_id": 20,
        "is_single": false,
        "support_takeaway": 1,
  ...
  },
  {
    ...
    "products": [
      ...
      },
      {
        ...
        "name": "多肉杨梅",
        "no": "2004238175994068",
        "description": "冷670ml 精选当季云南鲜杨梅，颗颗手剥去核。搭配来自优质茶园的绿妍原茶及按摩院经典芝士，冰凉消暑。",
        "label": "",
        "category_id": 12,
        "is_single": false,
        "support_takeaway": 1,
  ...
  },
  {
    ...
    "products": [
      ...
      },
      {
        ...
        "name": "芝芝脆筒",
        "no": "1907049396650773",
        "description": "由于冰淇淋易化，下单后需到冰淇淋机出示购买凭证制作领取，敬请谅解。首次将按摩院经典芝士与冰淇淋结合，芝香浓郁，乳香丝滑。",
        "label": "冰激淋",
        "category_id": 17,
        "is_single": true,
        "support_takeaway": 0,
    ...
    "products": [
      {
        ...
        "name": "芝芝绿妍",
        "no": "1911069353676862",
        "description": "冷/热500ml 芝士分装无法选择烤黑糖。按摩院定制绿茶，较普通绿茶，少了几分涩气，口感清澈，茉莉香气馥郁怡人。",
        "label": "",
        "category_id": 1,
        "is_single": true,
        "support_takeaway": 1,
      ...
      },
      {
        ...
        "name": "芝芝金玉",
        "no": "1911062610264848",
        "description": "冷/热500ml 芝士分装无法选择烤黑糖。按摩院定制乌龙，清新茶香中带有桂花香和淡淡的乳香，馥郁迷人。",
        "label": "",
        "category_id": 1,
        "is_single": true,
        "support_takeaway": 1,
      ...
      },
      {
        ...
        "name": "芝芝金凤茶王",
        "no": "1911063020240079",
        "description": "冷/热500ml 芝士分装无法选择烤黑糖。按摩院定制乌龙茶，香气炭焙浓郁，入喉回甘，茶香余韵不断。",
        "label": "",
        "category_id": 1,
        "is_single": true,
        "support_takeaway": 1,
      ...
      },
      {
        ...
        "name": "芝芝嫣红2.0",
        "no": "1911064895831191",
        "description": "冷/热 500ml 芝士分装无法选择烤黑糖。按摩院定制红茶，茶底全新升级为蜜香红茶，汤色红艳明亮，口味丰富深沉。",
        "label": "",
        "category_id": 1,
        "is_single": true,
        "support_takeaway": 1,
  ...
  },
  {
    ...
    "products": [
      ...
      },
      {
        ...
        "name": "芝芝咖啡",
        "no": "1903209749549957",
        "description": "冷500ml  热360ml  咖啡外送可能会影响口感。意式奶咖与按摩院芝士的默契结合，带来更浓郁的奶香。",
        "label": "",
        "category_id": 15,
        "is_single": true,
        "support_takeaway": 1,
    ...
    "products": [
      {
        ...
        "name": "热阿华田波波",
        "no": "1910180943088468",
        "description": "500ml 按摩院×阿华田联名款，口感较甜腻。颗颗软糯的黑糖波波坠入鲜牛奶，结合活力满满的阿华田酷脆酱、阿华田脆脆与黑糖布蕾，口口香脆。如需选购冷饮，请在波波家族点选。",
        "label": "",
        "category_id": 7,
        "is_single": true,
        "support_takeaway": 1,
    ...
    "products": [
      {
        ...
        "name": "纯绿妍",
        "no": "1902229954555253",
        "description": "冷/热500ml（纯茶系列无芝士）按摩院定制绿茶，气质淡雅芳幽，散发着清逸的茉莉香气，馥郁怡人。",
        "label": "",
        "category_id": 6,
        "is_single": true,
        "support_takeaway": 1,
      ...
      },
      {
        ...
        "name": "纯金玉",
        "no": "1901104953102101",
        "description": "冷/热500ml（纯茶系列无芝士）按摩院定制乌龙，清新茶香中带有桂花香和淡淡的乳香，馥郁迷人。",
        "label": "",
        "category_id": 6,
        "is_single": true,
        "support_takeaway": 1,
      ...
      },
      {
        ...
        "name": "纯金凤茶王",
        "no": "1902225410210057",
        "description": "冷/热500ml（纯茶系列无芝士）按摩院定制乌龙茶，香气炭焙浓郁，入喉回甘，茶香余韵不断。",
        "label": "",
        "category_id": 6,
        "is_single": true,
        "support_takeaway": 1,
      ...
      },
      {
        ...
        "name": "纯嫣红2.0",
        "no": "1902229953995457",
        "description": "冷/热500ml（纯茶系列无芝士）按摩院定制红茶，茶底全新升级为蜜香红茶，汤色红艳明亮，口味丰富深沉。",
        "label": "",
        "category_id": 6,
        "is_single": true,
        "support_takeaway": 1,
  ...
  },
  {
    ...
    "products": [
      ...
      },
      {
        ...
        "name": "加料冰淇淋",
        "no": "1908066825277032",
        "description": "不是单独吃的冰淇淋，如需购买直接吃的冰淇淋请在“按摩院制冰”系列选购。温馨提示：冰淇淋运送途中易融化，请酌情加购。1.加在饮品里（请您务必备注需要加料是哪杯饮品）2.单独分装（1元打包费）",
        "label": "冰激淋",
        "category_id": 9,
        "is_single": true,
        "support_takeaway": 1,
    ...
    "products": [
      {
        ...
        "name": "无接触配送",
        "no": "2001147783071999",
        "description": "防疫期间，您可通过订单备注及电话告知等方式，引导骑手将外卖商品放在指定位置，例如：悬挂门把手、放置大堂桌面，避免接触，降低风险。由于茶饮均为现点现制，高峰期外送时间预计为1小时左右，建议您提前点单。如果您有任何建议或遇到配送、撒漏等问题，可拨打本店电话反馈（高峰期可能会出现忙线，还请谅解），也可前往按摩院-我的-联系客服，我们会尽快为您处理。",
        "label": "",
        "category_id": 59,
        "is_single": true,
        "support_takeaway": 1,
      ...
      },
      {
        ...
        "name": "门店防疫",
        "no": "2001290337601885",
        "description": "1.店员每日测量体温，全天佩戴口罩手套，每小时洗手消毒。2.每小时消毒店内可接触物，每四小时清洗消毒餐具。3.最大程度保持门店通风透气。4.门店现仅接受按摩院点单，降低接触频次。5.顾客及骑手须佩戴口罩方可进店。6.骑手进店前测量体温，所有外卖订单采取无接触配送。我们希望为大家提供安全的环境，愉快喝茶。",
        "label": "",
        "category_id": 59,
        "is_single": true,
        "support_takeaway": 1,
